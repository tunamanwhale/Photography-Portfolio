<template>
    <div>
        <div class="contact-holder fade-component">
            ...
            <!-- content START -->
            <div class="content">
                <p>I would love for my work to be seen as a celebration of human endeavour, whether concentrating on an individual’s personal sporting pursuits, or the artistry and craft involved in a highly skilled, labour-intensive industry.</p>
                <p>I accept work on an availability-basis, and would love to hear from you.</p>
            </div>
            <!-- content END -->
                ...
                <ul>
                    <li>
                        <a href="mailto:hello@coidea.website" target="_blank">
                            ...
                            <span>dailis.ian@gmail.com</span>
                        </a>
                    </li>
                </ul>
            </div>
