    ...
    <div>
        <div class="gallery" itemscope itemtype="http://schema.org/ImageGallery">
            ...
            >
                ...
                <figcaption class="gallery-caption" itemprop="caption description">Flowers
                    <br>Shelton, CT
                </figcaption>
            </figure>
            <figure
            ...
            >
                ...
                <figcaption class="gallery-caption" itemprop="caption description">Cat
                    <br>Shelton, CT
                </figcaption>
            </figure>
            ...
            >
                ...
                <figcaption class="gallery-caption" itemprop="caption description">Goshen, CT</figcaption>
            </figure>
            <figure
                class="gallery-item horizontal"
                itemprop="associatedMedia"
            ...
            >
                ...
                <figcaption
                    class="gallery-caption"
                    itemprop="caption description"
                >Temple of Debod, Madrid</figcaption>
            </figure>
            <figure
                class="gallery-item horizontal"
                itemprop="associatedMedia"
            ...
            >
                ...
                <figcaption
                    class="gallery-caption"
                    itemprop="caption description"
                >Fountain of Youth, Madrid</figcaption>
            </figure>
            <figure
                class="gallery-item horizontal"
                itemprop="associatedMedia"
            ...
            >
                ...
                <figcaption class="gallery-caption" itemprop="caption description">Lake George
                    <br>Adirondacks, New York
                </figcaption>
            </figure>
            <figure
                class="gallery-item horizontal"
            ...
            >
                ...
                <figcaption class="gallery-caption" itemprop="caption description">Rumped Toad
                    <br>Adirondacks, New York
                </figcaption>
            </figure>
            <figure
            ...
            >
                ...
                <figcaption class="gallery-caption" itemprop="caption description">Peacock
            ...
            >
                ...
                <figcaption class="gallery-caption" itemprop="caption description">Great Horned Owl
                    <br>Palos Verdes, California
                </figcaption>
            </figure>
            <figure
                class="gallery-item horizontal"
            ...
            openPhotoSwipe = function(
                ...
                options = {
                    ...
                    getThumbBoundsFn: function(index) {
                        ...
                        thumbnail = items[index].el.getElementsByTagName(
                            "img"
                        )[0];
                        pageYScroll =
                            window.pageYOffset ||
...
[id="sidebar"] a:before {
    ...
    transition: transform 0.3s, transform-origin 0.3s, -webkit-transform 0.3s,
        -webkit-transform-origin 0.3s;
    background: black;
    z-index: -1;
}
[id="sidebar"] a:hover {
...
[id="sidebar"] a:hover:before {
    ...
    transition: transform-origin 0s, transform 0.3s, -webkit-transform-origin 0s,
